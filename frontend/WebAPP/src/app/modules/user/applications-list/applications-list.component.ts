...
import { ApplicationService } from 'src/app/core/services/http/application.service';
...
export class ApplicationsListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.queryParamMap.subscribe((param) => {
      ...
      this.applicationService.getAllUser(data).subscribe((res) => {
  ...
  filter() {
    ...
    this.router.navigate(['/usuario/postulaciones'], {queryParams: params});
  }
